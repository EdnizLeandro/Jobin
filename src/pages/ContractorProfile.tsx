...
import {User, MapPin, Briefcase, Plus, Bell, Settings, LogOut, DollarSign, Calendar, TrendingUp, Star, Clock, CheckCircle, Users, Target} from 'lucide-react'
...
const ContractorProfile = () => {
  ...
  const handleCreateContract = () => {
    ...
    // Aqui implementaria a navegação para página de criação de contrato
  }
  ...
  const contractorData = profile.contractor_data || {}
  const activeContracts = contracts.filter(c => c.status === 'accepted' || c.status === 'in_progress')
  const completedContracts = contracts.filter(c => c.status === 'completed')
  const pendingContracts = contracts.filter(c => c.status === 'pending')

  const totalSpent = completedContracts.reduce((acc, contract) => acc + contract.value, 0)
  const averageContractValue = completedContracts.length > 0 ? totalSpent / completedContracts.length : 0
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-600 font-medium">Contratante</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div className="bg-purple-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm text-purple-600">Total de Contratos</div>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-2xl font-bold text-green-900">{completedContracts.length}</div>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm text-yellow-600">Investido</div>
                </div>
              </div>
              ...
              {contractorData.company_name && (
                <div className="border-t pt-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Informações da Empresa</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-gray-600">Empresa</p>
                      <p className="font-medium">{contractorData.company_name}</p>
                    </div>
                    {contractorData.industry && (
                      <div>
                        <p className="text-sm text-gray-600">Setor</p>
                        <p className="font-medium">{contractorData.industry}</p>
                      </div>
                    )}
                  </div>
                </div>
            ...
            <motion.div
              ...
              className="bg-white rounded-xl shadow-sm p-6"
            >
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Análise de Performance</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    {completedContracts.length > 0 ? '95%' : '0%'}
                  </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    R$ {Math.round(averageContractValue).toLocaleString('pt-BR')}
                  </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    {contractorData.rating?.toFixed(1) || '5.0'}
                  </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="text-gray-700">Criar Contrato</span>
                </button>
                ...
                >
                  ...
                  <span className="text-gray-700">Buscar Profissionais</span>
                </button>
                ...
                >
                  ...
                  <span className="text-gray-700">Gerenciar Contratos</span>
                </button>
            ...
            <motion.div
              ...
              className="bg-white rounded-xl shadow-sm p-6"
            >
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Contratos Pendentes</h3>
              
              {pendingContracts.length === 0 ? (
                <p className="text-gray-500 text-sm">Nenhum contrato pendente</p>
              ) : (
                <div className="space-y-3">
                  {pendingContracts.slice(0, 3).map((contract) => (
                    <div key={contract._id} className="border border-gray-200 rounded-lg p-3">
                      <h4 className="font-medium text-sm text-gray-900">{contract.title}</h4>
